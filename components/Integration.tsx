  ...
  return (
    ...
    <div className='max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16'>
      <div className='flex-1'>
       <h2 className='text-3xl md:text-4xl font-medium text-white tracking-tight mb-10'>
          Drop-in simplicity
       </h2>
       <p className='text-lg text-zinc-400 font-light mb-8 leading-relaxed'>
         No complex sdks or user syncing . Just add our script tag and youare live. we
       </p>
       <div className='flex flex-col gap-4 '>
        <div className='flex items-center gap-4 text-sm text-white font-light'>
            <div className='w-6 flex h-6 rounded-full bg-zinc-900 border border-zinc-700 items-center justify-center'>
               1
            </div>
          ...
          <div className='font-mono text-xs md:text-sm leading-7 text-zinc-400'>
             ...
             <div className='pl-4'>
               ...
               <span className='text-emerald-400'>
                &quot;https://onesupport.com/init.js&quot;
               </span>
             </div>
             <div className='pl-4'> 
                 <span className='text-indigo-400'>data-id</span>
                 <span className='text-emerald-400'>&quot;b7456-126-485&quot;</span>
                 <br />
